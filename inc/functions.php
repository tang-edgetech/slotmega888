...
if ( isLocalhost() ) {
    ...
    $site_base_url = 'http://branch.us.com/';
    $cdn_asset_url = $site_base_url;
...
$icon_playnow = '<svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" viewBox="0 0 32 32" id="chip">
  <path d="m16 11.5-3.17 3.34a1.87 1.87 0 0 0 0 2.52 1.63 1.63 0 0 0 2.34 0 .75.75 0 0 1 .15-.13.44.44 0 0 1 .43 0 .35.35 0 0 1 .19.34 6.38 6.38 0 0 1-1.15 3.09h2.42a6.38 6.38 0 0 1-1.15-3.09.35.35 0 0 1 .18-.36.4.4 0 0 1 .42 0 .7.7 0 0 1 .17.14 1.63 1.63 0 0 0 2.34 0 1.86 1.86 0 0 0 0-2.52Z"></path>
