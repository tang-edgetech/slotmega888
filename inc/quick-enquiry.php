        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-11 col-xl-6 col-xxl-5 px-4">
                ...
                <div class="d-grid col-12 col-md-10 mx-auto mt-4">
                    <a href="https://tinyurl.com/3932x6sr" target="_blank" class="btn btn-rounded btn-with-icon btn-playnow text-white" rel="nofollow noreferrer noopener"><?php echo $icon_playnow;?><span><b>Play Online Now</b></span></a>
                </div>
            </div>
        </div>
    </div>
